...
\begin{example}
    ...
    \begin{figure}%
        ...
        \caption{First through seventh steps of the~state removal algorithm with order~$\omega$\\ \X{Fix the automatons in the figure!}}\label{fig:automaton_R8_state_removal_steps}%
    \end{figure}
\end{example}
