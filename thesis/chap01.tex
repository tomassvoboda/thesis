...
\X{expression denotes language $L[\re{E}]$}

We say that a language of $A^*$ is \emph{rational} if and only if it is denoted by a rational expression over $A$. We consider two rational expressions \emph{equivalent} if they denote the same language.
