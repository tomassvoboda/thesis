...
Brzozowski and McCluskey~\cite{BrzozowskiMcCluskey64} used generalised forms of automata to show that there is a~simple algorithm that takes a~finite automaton and returns a~rational expression denoting the same language that is accepted by the automaton. This algorithm is used in Lemma~\ref*{lm:expression_existence} to find a~rational expression denoting the language recognised by a~ring automaton.
